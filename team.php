...
<div id="page-con-content">
	...
	<div id="page-con-container">
		<div id="page-in-container" style="overflow: visible !important; overflow-x: visible !important;">
			...
			<!-- End -->
			<div id='featured-con-block' class="div-member-block">
				<div class="div-role-cman" id='featured-ava-block' style="background: url('/img/members/ani.png') no-repeat center; background-size: cover;" title="The biggest weeb I have ever met">
			...
			<div id='featured-con-block' class="div-member-block">
				...
				<div class="div-avatar-block" id='featured-wrp-block'>
					...
					<div id='featured-tx2-block'>
						<p>
							 Shadow, being one of the eldest team members for RPCS3, is owner of both the RPCS3 and Emunewz web servers. Shadow has also made small, yet meaningful contributions to the emulator over the years and still continues to do so every now and then.
						</p>
					</div>
				</div>
			</div>
			...
			<div id='featured-con-block' class="div-member-block">
				...
				<div class="div-avatar-block" id='featured-wrp-block'>
					<div id='featured-tx1-block'>
						...
						<p class="div-txt-role div-role-desi">
							 Designer
						</p>
						</h2>
					</div>
			...
			<div id='featured-con-block' class="div-member-block">
				...
				<div class="div-avatar-block" id='featured-wrp-block'>
					...
					<div id='featured-tx2-block'>
						<p>
							Co-founding the project with DH, Hykem is responsible for reverse-engineering many of PlayStation 3's features. He reversed the security features and built a cryptographic engine which emulated various aspects of PS3's security features. He is the developer of many well known tools in the scene such as make_npdata. <a href='http://www.emunewz.net/forum/showthread.php?tid=174735'>He was forced to leave the project in mid 2016.</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div id='featured-con-block' class="div-member-block">
				...
				<div class="div-avatar-block" id='featured-wrp-block'>
					...
					<div id='featured-tx2-block'>
						<p>
							 gopalsr83 is a past developer and team member for RPCS3 and is currently not working on the project anymore from now and into the future. This past developer is deceased and more information will be gathered on his contributions at a later date.
						</p>
					</div>
				</div>
			</div>
