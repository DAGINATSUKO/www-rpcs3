...
$(window).scroll(function() {    
    ...
    if (scroll >= 440) {
        $("#menu-con-navbar ").addClass("div-navbar-opacity ");
    } else {
        $("#menu-con-navbar ").removeClass("div-navbar-opacity ");
    }
});
/*--------------------------------------------------------------------------------------------------------------------------------------*/
$(document).ready(function() {
...
$(document).ready(function() {
    $(".toggle-donate").hide();
    $("#menu-con-donate").click(function() {
        $(".toggle-donate").fadeToggle(100);
    });
    $(".toggle-donate").hide();
    $(".toggle-donate").click(function() {
        $(".toggle-donate").fadeOut(100);
    });
});
$(document).ready(function() {
    $(".toggle-alipay").hide();
    $(".menu-con-alipay").click(function() {
        $(".toggle-alipay").delay(288).fadeToggle(100);
    });
    $(".toggle-alipay").hide();
