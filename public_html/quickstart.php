		...
		<div id="page-in-container">
			...
			<div id='featured-con-block' class="lightmode-block">
				...
				<div id='featured-wrp-block'>
					...
					<div id='featured-tx2-block' class="lightmode-txt">
						<p>
							 Due to legal reasons, we cannot distribute official PlayStation 3 firmware files. You must download the latest PlayStation 3 firmware update file from <a href="https://www.playstation.com/en-us/support/system-updates/ps3/">PlayStation.com</a> for use with RPCS3. Once downloaded, you must install the firmware using RPCS3's built in firmware installer found under <b class="txt-highlight lightmode-highlight">File > Install Firmware.</b>
						</p>
					</div>
				</div>
			</div>
			...
			<div id='featured-con-block' class="lightmode-block">
				...
				<div id='featured-wrp-block'>
					...
					<div id='featured-tx2-block' class="lightmode-txt">
						...
						<br>
						<p>
							<b class="txt-highlight lightmode-highlight">Automatically load required libraries:</b> Automatically loads all required modules in game executable.
						</p>
						<p>
							<b class="txt-highlight lightmode-highlight">Manually load selected libraries:</b> Allows the user to manually load selected firmware modules.
						</p>
						<p>
							<b class="txt-highlight lightmode-highlight">Load automatic and manual libraries:</b> Automatically loads all required modules and manually selected firmware modules at the same time.
						</p>
						<p>
							<b class="txt-highlight lightmode-highlight">Load liblv2.sprx only:</b> Loads modules dynamically, more closely to what a real PlayStation 3 would do. Some games may not work properly with this option yet.
						</p>
					</div>
				</div>
			</div>
			...
			<div id='featured-con-block' class="lightmode-block">
				...
				<div id='featured-wrp-block'>
					...
					<div id='featured-tx2-block' class="lightmode-txt">
						<p>
							 • PlayStation 3 save data files can be managed in: <b class="txt-highlight lightmode-highlight">\dev_hdd0\home\00000001\savedata\</b>
						</p>
						<p>
							 • Please note that save data is stored in folders that correspond to your game's ID.
						</p>
						<p>
							<i>Note: If you're on linux, RPCS3 folders are located in: <b class="txt-highlight lightmode-highlight">~/.config/rpcs3/</b></i>
						</p>
					</div>
				</div>
			</div>
			...
			<div id='featured-con-block' class="lightmode-block">
				...
				<div id='featured-wrp-block'>
					...
					<div id='featured-tx2-block' class="lightmode-txt">
						...
						<br>
						<p>
							 The typical layout of a <b class="txt-highlight lightmode-highlight">Blu-ray Disc</b> game's root directory:
						</p>
						<p>
						...
						<br>
						<p>
							 The typical layout of a <b class="txt-highlight lightmode-highlight">PlayStation Network </b> game's root directory:
						</p>
						<p>
						...
						<br>
						<p>
							 Both Blu-ray and PlayStation Network games must be placed in a single folder with their respective files and the folder name must correspond to the game's ID. If you are not sure what your dumped game's region ID is, you can find your region ID on the bottom side-edge of your game case. If you are no longer in possession of your game case or your game is a PlayStation Network game, you can do an internet search for <b class="txt-highlight lightmode-highlight">"Your Game Name Here</b> + <b class="txt-highlight lightmode-highlight">Region ID"</b>. Please note that it is very important you use the correct region ID.
						</p>
						<br>
						<p>
							 • Game IDs that start with a <b class="txt-highlight lightmode-highlight">B</b> are <b class="txt-highlight lightmode-highlight">Blu-Ray Disc</b> games
						</p>
						<p>
							 • Game IDs that start with a <b class="txt-highlight lightmode-highlight">N</b> are <b class="txt-highlight lightmode-highlight">PlayStation Network</b> games
						</p>
						<br>
						<p>
						...
						<br>
						<p>
							 • For example: <b class="txt-highlight lightmode-highlight">BLUS30443</b> is an USA <b class="txt-highlight lightmode-highlight">Blu-Ray Disc</b> copy of <b class="txt-highlight lightmode-highlight">Demon's Souls</b>
						</p>
						<p>
							 • For example: <b class="txt-highlight lightmode-highlight">NPEB02436</b> is an Europe <b class="txt-highlight lightmode-highlight">PlayStation Network</b> copy of <b class="txt-highlight lightmode-highlight">Persona 5</b>
						</p>
					</div>
				</div>
			</div>
			...
			<div id='featured-con-block' class="lightmode-block">
				...
				<div id='featured-wrp-block'>
					...
					<div id='featured-tx2-block' class="lightmode-txt">
						<p>
							 • .pkg files must be extracted using RPCS3's built-in package installer found under <b class="txt-highlight lightmode-highlight">File > Install .pkg</b>
						</p>
						<p>
							 • .pkg files will be automatically installed to: <b class="txt-highlight lightmode-highlight">\dev_hdd0\game\</b>
						</p>
						<p>
							 • Blu-ray Disc game data can be placed in <b class="txt-highlight lightmode-highlight">\dev_hdd0\disc\</b> or anywhere <b class="txt-highlight lightmode-highlight">except</b> for <b class="txt-highlight lightmode-highlight">\dev_hdd0\game\</b> and can be booted from <b class="txt-highlight lightmode-highlight">File > Boot Game</b> if not present on game list
						</p>
						<p>
							 • PlayStation Network game data must be placed in: <b class="txt-highlight lightmode-highlight">\dev_hdd0\game\</b>
						</p>
						<p>
							 • PlayStation Network .rap files must be placed in: <b class="txt-highlight lightmode-highlight">\dev_hdd0\home\00000001\exdata\</b>
						</p>
						<p>
							<i>Note: If you're on linux, RPCS3 folders are located in: <b class="txt-highlight lightmode-highlight">~/.config/rpcs3/</b></i>
						</p>
			...
			<div id='featured-con-block' class="lightmode-block">
				...
				<div id='featured-wrp-block'>
					...
					<div id='featured-tx2-block' class="lightmode-txt">
						...
						<br>
						<p>
							<b>Method B:</b> You can dump games using only a computer by using select compatible Blu-ray drives. Please note that you can only use this method if an <b class="txt-highlight lightmode-highlight">.ird</b> file is available online for the decryption of the disc. See <b class="txt-highlight lightmode-highlight">Dumping games and software with a Blu-ray drive</b> below. Not every Blu-ray drive will recognize PlayStation 3 games due to how PlayStation 3 format discs are designed. Here's a compiled list of the known compatible Blu-ray drives that are capable of reading PlayStation game discs:
						</p>
						<br>
						<p>
							 • ASUS <b class="txt-highlight lightmode-highlight">BC-08B1LT</b>
						</p>
						<p>
							 • ASUS <b class="txt-highlight lightmode-highlight">BC-16D1HT</b>
						</p>
						<p>
							 • ASUS <b class="txt-highlight lightmode-highlight">BC-12B1ST</b>
						</p>
						<p>
							 • ASUS <b class="txt-highlight lightmode-highlight">BC-12D2HT</b>
						</p>
						<p>
							 • ASUS <b class="txt-highlight lightmode-highlight">BW-12B1ST</b>
						</p>
						<p>
							 • ASUS <b class="txt-highlight lightmode-highlight">BW-16D1HT</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">BH26NS40</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">UH12NS30</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">BH16NS40</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">BH16NS48</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">BH14NS40</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">WH24NS40</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">WH12LS30</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">WH24LS30</b>
						</p>
						<p>
							 • LG <b class="txt-highlight lightmode-highlight">WH26NS40</b>
						</p>
						<p>
						...
						<p>
							 • Lite-On <b class="txt-highlight lightmode-highlight">DH-4O1S</b>
						</p>
						<p>
							 • Lite-On <b class="txt-highlight lightmode-highlight">iHBS112</b>
						</p>
						<p>
							 • BENQ <b class="txt-highlight lightmode-highlight">BR1000</b>
						</p>
						<p>
							 • Samsung <b class="txt-highlight lightmode-highlight">DVDWBD SH-B083L</b>
						</p>
						<p>
							 • Sony Optiarc <b class="txt-highlight lightmode-highlight">5300S</b>
						</p>
						<p>
							 • Sony PlayStation stock drive <b class="txt-highlight lightmode-highlight">with proprietary adapter</b>
						</p>
					</div>
				</div>
			</div>
			...
			<div id='featured-con-block' class="lightmode-block">
				...
				<div id='featured-wrp-block'>
					...
					<div id='featured-tx2-block' class="lightmode-txt">
						...
						<p>
							 • <b class="txt-highlight lightmode-highlight">ISO Dumping Software</b>, such as <a href="http://www.imgburn.com/">ImgBurn</a>, for example.
						</p>
						<br>
						<p>
						...
						<p>
							 2. Dump the <b class="txt-highlight lightmode-highlight">.iso</b> image using an ISO Dumping program such as ImgBurn.
						</p>
						<p>
							 3. Use <a href="http://jonnysp.bplaced.net">jonnysp.bplaced.net</a> to locate the appropriate <b class="txt-highlight lightmode-highlight">.ird</b> file that matches your game ID. If there isn't any .ird file that matches your game ID this unfortunately means you can't dump your disc using this method.
						</p>
						<p>
							...
							<p>
								 5. Open <b class="txt-highlight lightmode-highlight">PS3 ISO Patcher</b> and select your dumped <b class="txt-highlight lightmode-highlight">.iso</b> file and its appropriate <b class="txt-highlight lightmode-highlight">.ird</b> file.
							</p>
							<p>
								 6. Press <b class="txt-highlight lightmode-highlight">Patch</b> to apply the patch to the .iso file.
							</p>
							<p>
								 7. Open <b class="txt-highlight lightmode-highlight">3k3y ISO Tools</b>. Click the <b class="txt-highlight lightmode-highlight">ISO Crypto</b> option and select the dumped .iso file to decrypt it. Make sure the .iso file extension is in lower-case letters (.iso not .ISO), or the decryption will not work.
							</p>
							<p>
								 8. Your game should now be properly decrypted.
							</p>
							<p>
								 9. While in 3k3y ISO Tools, in the Tools drop-down menu, select <b class="txt-highlight lightmode-highlight">ISO -> Extract ISO</b> and select the decrypted iso file to extract the game files (the decrypted iso file will have a .dec.iso file extension).
							</p>
							<p>
