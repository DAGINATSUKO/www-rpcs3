...
<div class="user-con-content darkmode-txt">
	...
	<div class="user-con-wrapper">
		...
		<div class="user-con-subtitle">
			<span class="user-tx1-subtitle ">Computer(s) Specifications</span>
		</div>
		<div class="user-con-specsheet">
			<div class="user-con-specbox">
				<div class="specbox-con-part darkmode-specbox">
...
<div class="user-con-content darkmode-txt">
	...
	<div class="user-con-wrapper">
		...
		<div class='user-tx3-content darkmode-txt'>
			<span>Silent started contributing to the project with miscellaneous UI fixes and later concentrated his efforts on different Windows input APIs, as well as his pet peeve, unicode support.</span>
		</div>
		<div class="user-con-subtitle">
			<span class="user-tx1-subtitle ">Computer(s) Specifications</span>
		</div>
...
<div class="user-con-content darkmode-txt">
	...
	<div class="user-con-wrapper">
		...
		<div class='user-tx3-content darkmode-txt'>
			<span>
			Yahfz joined RPCS3 in early 2017, he currently supports the project as a debugger focused on resolving bottlenecks with an endless goal of making the emulator better for everyone on every platform. </span>
		</div>
		<div class="user-con-subtitle">
			<span class="user-tx1-subtitle ">Computer(s) Specifications</span>
		</div>
