...
$drives->add_drive('LG', 'WH12LS30', DriveType::Internal, 'Some revisions');
...
$drives->add_drive('ASUS', 'BC-12B1ST', DriveType::Internal, 'Some revisions');
$drives->add_drive('ASUS', 'BC-12D2HT', DriveType::Internal);
$drives->add_drive('ASUS', 'BC-16D1HT', DriveType::Internal);
$drives->add_drive('ASUS', 'BW-12B1ST', DriveType::Internal);
...
$drives->add_drive('LITE-ON', 'IHBS112', DriveType::Internal);
$drives->add_drive('LITE-ON', 'IHBS312', DriveType::Internal);
