...
$drives->add_drive('LG', 'BH14NS50', DriveType::Internal);
...
$drives->add_drive('LG', 'BH16NS50', DriveType::Internal);
...
$drives->add_drive('LG', 'BP71N', DriveType::Internal);
...
$drives->add_drive('LG', 'CH12NS40', DriveType::Internal);
...
$drives->add_drive('LG', 'WH16NS58', DriveType::Internal);
...
$drives->add_drive('ASUS', 'BW-16D1X-U', DriveType::External, 'BU50N model only');
$drives->add_drive('ASUS', 'SBW-06D2X-U', DriveType::External, 'BU50N model only');
$drives->add_drive('ASUS', 'SBW-06D5H-U', DriveType::External, 'BU50N model only');
$drives->add_drive('BenQ', 'BR1000', DriveType::Internal);
$drives->add_drive('Buffalo', 'BN14', DriveType::External);
$drives->add_drive('Buffalo', 'BRUHD-PU3-BK', DriveType::External);
$drives->add_drive('Buffalo', 'BRXL-PT6U2V', DriveType::External);
$drives->add_drive('Buffalo', 'BRXL-PTV6U3', DriveType::External);
$drives->add_drive('Buffalo', 'BRXL-PUS6U3B', DriveType::External);
...
$drives->add_drive('LITE-ON', 'DH-8E2L', DriveType::Internal);
