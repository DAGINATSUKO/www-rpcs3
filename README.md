...
From there, open a web browser of your choosing and navigate to [localhost:8080](http://localhost:8080), [localhost:8888](http://localhost:8888) or your prefered localhost address.
